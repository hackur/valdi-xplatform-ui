...
- ALWAYS use Style<T> type parameters - `Style<View>` or `Style<Label>` (Valdi compiler requires them)
- Run `./scripts/fix-style-types.sh` to auto-add missing type parameters
